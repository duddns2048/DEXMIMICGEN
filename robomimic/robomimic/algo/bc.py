...
class BC(PolicyAlgo):
    ...
    def _compute_losses(self, predictions, batch):
        ...
        losses["l1_ns_loss"] = nn.L1Loss()(actions, a_target)
        ...
        action_losses = [
            ...
            self.algo_config.loss.l1_ns_weight * losses["l1_ns_loss"],
    ...
    def log_info(self, info):
        ...
        if "l1_ns_loss" in info["losses"]:
            log["L1_NS_Loss"] = info["losses"]["l1_ns_loss"].item()
